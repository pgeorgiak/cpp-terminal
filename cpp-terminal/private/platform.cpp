...
Term::Private::BaseTerminal::~BaseTerminal() noexcept(false) { store_and_restore(); }

Term::Private::BaseTerminal::BaseTerminal(bool enable_keyboard, bool disable_signal_keys) : keyboard_enabled{enable_keyboard}
{
  store_and_restore();
#ifdef _WIN32
